function simulate_noisy_whole_brains(path_of_script,VG,bval,bvec,simulated_tensors,b0,fit_data,path_defaults,masked_volume)
...
outdir_fit_results_lambda100 = [path_of_script filesep '..' filesep 'data' filesep 'results' filesep 'noisy_data' filesep 'whole_brains_lambda_equals_100'];
create_directories_noisy_whole_brains(outdir_fit_results_lambda100, snrs, number_of_noise_samples,simulation_parameters)

outdir_fit_results_lambda10 = [path_of_script filesep '..' filesep 'data' filesep 'results' filesep 'noisy_data' filesep 'whole_brains_lambda_equals_10'];
create_directories_noisy_whole_brains(outdir_fit_results_lambda100, snrs, number_of_noise_samples,simulation_parameters)
    ...
    for inx_snr = 1 : size(snrs,2)
        ...
        for inx_number_of_noise_samples = 1: number_of_noise_samples
            ...
            if fit_data
                ...
                path_fit_results_lambda100 = [outdir_fit_results_lambda100 filesep 'simulated_SNR_' num2str(simulation_parameters.simulated_SNRs(inx_snr)) filesep 'noise_sample_' num2str(inx_number_of_noise_samples) filesep simulation_parameters.measurement_protocol{inx_protocol}];
                path_fit_results_lambda10 = [outdir_fit_results_lambda10 filesep 'simulated_SNR_' num2str(simulation_parameters.simulated_SNRs(inx_snr)) filesep 'noise_sample_' num2str(inx_number_of_noise_samples) filesep simulation_parameters.measurement_protocol{inx_protocol}];
                roi = {path_wm_westin_mask};
                roi_msPOAS = {path_wm_mask};
                noise_in_image = ( (1/(simulation_parameters.simulated_SNRs(inx_snr))) ) * signal_scaling_factor;     %SNR = S0/sigma
                

                if inx_protocol == 1
                    jobfile_lambda100 = {[path_of_script filesep '..'  filesep 'batches' filesep 'batch_msPOAS_and_fit_dki_axdki_LAMBDA100_73e1d23dc_job.m']};
                    fit_simulated_noisy_whole_brain_data_variable_lambda(jobfile_lambda100,path_dMRI_dataset,bvalues,bvectors,fname,path_defaults,path_fit_results_lambda100,17,roi,roi_msPOAS,noise_in_image)
                    
                    jobfile_lambda10 = {[path_of_script filesep '..'  filesep 'batches' filesep 'batch_msPOAS_and_fit_dki_axdki_LAMBDA10_73e1d23dc_job.m']};
                    fit_simulated_noisy_whole_brain_data_variable_lambda(jobfile_lambda10,path_dMRI_dataset,bvalues,bvectors,fname,path_defaults,path_fit_results_lambda10,17,roi,roi_msPOAS,noise_in_image)
                elseif inx_protocol == 2
                    jobfile_fast_protocol_100 = {[path_of_script filesep '..'  filesep 'batches' filesep 'batch_msPOAS_and_fit_dki_axdki_LAMBDA100_FAST_PROTOCOL_73e1d23dc_job.m']};
                    fit_simulated_noisy_whole_brain_data_LAMBDA100_FAST_PROTOCOL(jobfile_fast_protocol_100,path_dMRI_dataset,bvalues,bvectors,fname,path_defaults,path_fit_results_lambda100,17,roi,roi_msPOAS,noise_in_image)

                    jobfile_fast_protocol_10 = {[path_of_script filesep '..'  filesep 'batches' filesep 'batch_msPOAS_and_fit_dki_axdki_LAMBDA10_FAST_PROTOCOL_73e1d23dc_job.m']};
                    fit_simulated_noisy_whole_brain_data_variable_lambda_fast(jobfile_fast_protocol_10,path_dMRI_dataset,bvalues,bvectors,fname,path_defaults,path_fit_results_lambda10,17,roi,roi_msPOAS,noise_in_image);
                end 
            end
