function  fit_simulated_noisy_whole_brain_data_variable_lambda_fast(jobfile,dMRI_dataset,bval,bvec,filename,path_defaults,outdir,nworkers,roi_fit,roi_msPOAS,noise)
