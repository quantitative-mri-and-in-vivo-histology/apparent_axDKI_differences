function  fit_simulated_noisy_whole_brain_data(jobfile,dMRI_dataset,bval,bvec,filename,path_defaults,outdir,nworkers,roi,noise)
...
% inputs{5, crun} = {outdir}; % Startup: Output directory - cfg_files
% inputs{6, crun} = {path_defaults}; % Startup: Customised - cfg_files
% inputs{7, crun} = roi; % msPOAS: Region of interest - cfg_files
...
% inputs{10, crun} = roi; % Diffusion Kurtosis Imaging (DKI): Region of interest - cfg_files
