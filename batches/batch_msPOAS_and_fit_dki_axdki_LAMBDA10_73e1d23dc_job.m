%-----------------------------------------------------------------------
% Job saved on 21-Dec-2023 14:45:56 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
...
matlabbatch{2}.spm.tools.dti.prepro_choice.poas.lambda = 10;
matlabbatch{2}.spm.tools.dti.prepro_choice.poas.kappa_type.kappa_scaling = 1;
...
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.dummy_DKI = 1;
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.in_vols(1) = cfg_dep('msPOAS: Smoothed images', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rsource'));
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.bvals_bvecs.bvals_bvecs_exp_type.bvals_exp(1) = cfg_dep('Startup: Extracted/Imported b-values', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','bvals'));
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.bvals_bvecs.bvals_bvecs_exp_type.bvecs_exp(1) = cfg_dep('Startup: Extracted/Imported b-vectors', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','bvecs'));
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.dummy_algo.nlls_axDKI.dummy_nlls = 1;
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.dummy_algo.nlls_axDKI.dummy_RBC.RBC_OFF.dummy_RBC_OFF = 1;
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.dummy_algo.nlls_axDKI.dummy_write_K = 1;
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.dummy_algo.nlls_axDKI.n_workers = '<UNDEFINED>';
matlabbatch{4}.spm.tools.dti.fit_choice.dki_fit.mask = '<UNDEFINED>';
